import { PAGE_TIMELINE, PAGE_ACTIVITIES, PAGE_PROGRESS, MILLISECONDS_IN_SECOND, HOURS_IN_DAY, SECONDS_IN_HOUR, SECONDS_IN_MINUTE, MINUTES_IN_HOUR, LOW_PERCENT, MEDIUM_PERCENT, HUNDRED_PERCENT } from './constants';
