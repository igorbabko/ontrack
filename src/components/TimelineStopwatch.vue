...
onMounted(() => {
  if (props.timelineItem.isActive && props.timelineItem.hour === now.value.getHours()) {
    start()
  } else if (props.timelineItem.isActive) {
    updateTimelineItem(props.timelineItem, { isActive: false })
  }
})
